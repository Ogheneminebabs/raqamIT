...
export const LanguageIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m4 16-4-4L5 21m14-4-4-4-2 4" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 11a5.975 5.975 0 00-2.062-4.5M17 11c.21.32.399.66.561 1.023M17 11h-1.16a2.51 2.51 0 00-2.434 2.133 2.51 2.51 0 002.434 2.133H17m-5-4.266A5.975 5.975 0 009 6.5M12 11c-.21.32-.399.66-.561 1.023M12 11h1.16a2.51 2.51 0 012.434 2.133 2.51 2.51 0 01-2.434 2.133H12" />
  </svg>
);
...
export const CpuChipIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 16.5v-1.5m-3.75 0v-1.5m0-13.5v-1.5m-3.75 0v-1.5m0 16.5v-1.5M12 8.25v7.5" />
    </svg>
);
